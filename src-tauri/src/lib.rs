...
pub fn run() {
    tauri::Builder::default()
        ...
        .invoke_handler(tauri::generate_handler![
            ...
            api::external_calendar_status,
            api::connect_external_calendar,
            api::save_external_calendar_connection,
            api::fetch_external_calendar,
            api::disconnect_external_calendar,
